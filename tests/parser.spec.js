...
test.describe('E2E Upload UI', () => {
  test('drag and drop upload and persistence', async ({ page }) => {
    ...
    await expect(results.locator('ul li')).toHaveText('Monza - 2023-10-01 (1 laps)');
    ...
    await expect(page.locator('#results').locator('ul li')).toHaveText('Monza - 2023-10-01 (1 laps)');
  });
});
